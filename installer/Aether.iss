...
;
; Значок — docs\assets\aether.png. installer\make-art.py собирает из него
; .ico и картинки мастера, чтобы установщик можно было пересобрать без правок
; руками. PNG в репозитории — исходник, не рисунок скриптом.
